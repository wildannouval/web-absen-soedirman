                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Mahasiswa
                            <a href="absenAdmin.php" class="btn btn-info float-end">Tambah Data Mahasiswa +</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success"
                                                href="form_edit_mahasiswa.php?nim=<?php echo $row['nim']; ?>">Edit</a> |
                                            <a class="btn btn-danger"
                                                href="proses_delete_mahasiswa.php?nim=<?php echo $row['nim']; ?>"
