...
<head>
    ...
    <title>Dashboard - Table Mahasiswa</title>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Mahasiswa
                            <a href="mahasiswaadmin.php" class="btn btn-info float-end">Tambah Data Mahasiswa +</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success"
                                                href="form_edit_mahasiswa.php?upd=<?php echo $row['nim']; ?>">Edit</a> |
