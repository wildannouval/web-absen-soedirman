            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="crudabsen.php">
                        ...
                        <a class="nav-link" href="crudmahasiswa.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-table-list"></i></div>
                            Table Mahasiswa
                            <!-- <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div> -->
                        </a>
                        <a class="nav-link collapsed" href="crudmatakuliah.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-table-list"></i></div>
                            Table Matakuliah
                            <!-- <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div> -->
                        </a>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Absensi
                            <a href="absenAdmin.php" class="btn btn-info float-end">Tambah Data Absensi +</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success"
                                                href="form_edit_absensi.php?id_absen=<?php echo $row['id_absen']; ?>">Edit</a> |
                                            <a class="btn btn-danger"
                                                href="proses_delete_absensi.php?id_absen=<?php echo $row['id_absen']; ?>"
